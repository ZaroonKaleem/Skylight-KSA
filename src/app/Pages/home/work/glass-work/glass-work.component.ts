...
@Component({
  selector: 'app-glass-work',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './glass-work.component.html',
  styleUrl: './glass-work.component.css'
})
export class GlassWorkComponent {

  glassCategories = [
    {
      title: 'Commercial Glass & Aluminium',
      ...
      description: 'Premium glass solutions for office buildings, retail spaces, and commercial complexes with enhanced durability and design.',
      gallery: [
        '/gallery/walkIn.jpg',
        '/gallery/heraSt.jpg',
    ...
    },
    {
      ...
      description: 'Beautiful glass installations for homes, from windows to shower enclosures, combining aesthetics with functionality.',
      gallery: [
        ...
        'https://images.unsplash.com/photo-1600607688969-a5bfcd646154?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'
      ]
    },
    {
      title: 'Mirrors',
      ...
      description: 'Custom-cut flat glass and mirror solutions for both decorative and practical applications in any space.',
      gallery: [
        ...
        'https://images.unsplash.com/photo-1517705008128-361805f42e86?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
  ...
  nextImage() {
    this.currentImageIndex = (this.currentImageIndex + 1) % this.selectedCategory.gallery.length;
  }

  prevImage() {
    this.currentImageIndex = (this.currentImageIndex - 1 + this.selectedCategory.gallery.length) % this.selectedCategory.gallery.length;
  }
